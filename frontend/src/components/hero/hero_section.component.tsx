...
const HeroSectionComponent = () => {
  ...
  return (
    ...
    >
      ...
      {/* Hero content + mouse star tracking */}
      <div
      ...
      >
        <motion.div
          ...
          className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-16 sm:pt-20 sm:pb-20 text-center w-full box-border"
        >
          {/* Animated badge */}
          <div
            ref={badgeRef}
