        ...
        <ol className="space-y-8 relative z-10">
          {steps.map((step) => (
            <li key={step.step} className="relative flex gap-6">
              ...
              <div className="flex-1 bg-white dark:bg-white/[0.04] border border-slate-200 dark:border-white/10 rounded-xl p-6 shadow-sm hover:border-indigo-400 dark:hover:border-indigo-500/20 transition-colors">
