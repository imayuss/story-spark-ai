...
import TroubleshootCard from "../troubleshoot_card/troubleshoot_card.component.tsx";
    ...
    >
      <div className="mb-10 text-center">
        <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-orange-500/20 bg-orange-500/10 text-orange-400 mb-4">
          ...
          <span className="text-sm font-semibold uppercase">Troubleshooting Guide</span>
        </div>
